...
//this was changed from eu to us
...
//all us_west were previously eu_central

# Setup VPC
resource "aws_vpc" "dev_proj_1_vpc_us_west_1" {
...
resource "aws_subnet" "dev_proj_1_public_subnets" {
  ...
  vpc_id            = aws_vpc.dev_proj_1_vpc_us_west_1.id
  cidr_block        = element(var.cidr_public_subnet, count.index)
#change the availability zone to us from eu
...
#change the availability zone to eu to us
  availability_zone = element(var.us_availability_zone, count.index)
